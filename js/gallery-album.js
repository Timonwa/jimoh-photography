import { galleryAlbumImages } from "./photos.js";
...
for (var i = 0; i < galleryAlbumImages.length; i++) {
    albumCntr.innerHTML += '<span><img class="album-image" src="' + galleryAlbumImages[i][0] + '" alt="' + galleryAlbumImages[i][1] + '"></span>'
}
